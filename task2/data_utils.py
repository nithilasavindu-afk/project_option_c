# File: data_utils.py
# Task 2: Data Processing Utilities
# Utility functions for improved data handling
...
class DataProcessor:
    """
    Class to handle all data processing operations for Task 2
    """
    ...
    def prepare_sequences(self, scaled_data, sequence_length):
        """
        Prepare data sequences for LSTM training
        Based on the original v0.1 approach
        """
        x_data = []
        y_data = []
